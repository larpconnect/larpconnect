...
| DTO | `glossary/technical.md` | Data transfer objects and request records such as `CreateUserRequest`. |
| Server | `glossary/technical.md` | The application component hosting the API endpoints. |
| Module | `glossary/technical.md` | Gradle modules across the project. |
