...
Defines OpenTelemetry root span generation, client traceparent header isolation, response header injection, and Logback MDC correlation across the API plane.
