# guice-injector-hardening Specification

## Purpose

Enforces strict dependency injection invariants in the root Server application module, prohibiting circular proxies, requiring @Inject on constructed classes, requiring explicit module bindings, and enforcing exact binding annotations.
